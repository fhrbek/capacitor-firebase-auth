    ...
    */
    ...
    class GoogleSignInResult {
        constructor(idToken) {
            ...
            this.providerId = firebase$1.auth.GoogleAuthProvider.PROVIDER_ID;
        }
    }
    class TwitterSignInResult {
        constructor(idToken, secret) {
            this.idToken = idToken;
            this.secret = secret;
            this.providerId = firebase$1.auth.TwitterAuthProvider.PROVIDER_ID;
        }
    }
    class FacebookSignInResult {
        constructor(idToken) {
            this.idToken = idToken;
            this.providerId = firebase$1.auth.FacebookAuthProvider.PROVIDER_ID;
        }
    }
    ...
    class PhoneSignInResult {
        constructor(verificationId, verificationCode) {
            ...
            this.providerId = firebase$1.auth.PhoneAuthProvider.PROVIDER_ID;
        }
    }
    ...
    const facebookSignInWeb = () => __awaiter$1(void 0, void 0, void 0, function* () {
        const provider = new firebase$1.auth.FacebookAuthProvider();
        firebase$1.auth().useDeviceLanguage();
        const userCredential = yield firebase$1.auth().signInWithPopup(provider);
    ...
    const googleSignInWeb = () => __awaiter$2(void 0, void 0, void 0, function* () {
        try {
    ...
    const phoneSignInWeb = (options) => __awaiter$3(void 0, void 0, void 0, function* () {
    ...
    const twitterSignInWeb = () => __awaiter$4(void 0, void 0, void 0, function* () {
        try {
            const provider = new firebase$1.auth.TwitterAuthProvider();
            firebase$1.auth().useDeviceLanguage();
            const userCredential = yield firebase$1.auth().signInWithPopup(provider);
            const { credential } = userCredential;
    ...
    class CapacitorFirebaseAuthWeb extends WebPlugin {
        ...
        signIn(options) {
            return __awaiter$5(this, void 0, void 0, function* () {
                const googleProvider = new firebase$1.auth.GoogleAuthProvider().providerId;
                const facebookProvider = new firebase$1.auth.FacebookAuthProvider().providerId;
                const twitterProvider = new firebase$1.auth.TwitterAuthProvider().providerId;
                const phoneProvider = new firebase$1.auth.PhoneAuthProvider().providerId;
        ...
        signOut(options) {
            return __awaiter$5(this, void 0, void 0, function* () {
                console.log(options);
                return firebase$1.auth().signOut();
            });
        }
    }
    ...
    const cfaSignInGoogle = () => {
        return new Observable(observer => {
            // get the provider id
            const providerId = firebase$1.auth.GoogleAuthProvider.PROVIDER_ID;
            // native sign in
            plugin.signIn({ providerId }).then((result) => {
                // create the credentials
                const credential = firebase$1.auth.GoogleAuthProvider.credential(result.idToken);
                // web sign in
                firebase$1.app().auth().signInWithCredential(credential)
                    .then((userCredential) => {
    ...
    const cfaSignInTwitter = () => {
        return new Observable(observer => {
            // get the provider id
            const providerId = firebase$1.auth.TwitterAuthProvider.PROVIDER_ID;
            // native sign in
            plugin.signIn({ providerId }).then((result) => {
                // create the credentials
                const credential = firebase$1.auth.TwitterAuthProvider.credential(result.idToken, result.secret);
                // web sign in
                firebase$1.app().auth().signInWithCredential(credential)
                    .then((userCredential) => {
                    observer.next(userCredential.user);
    ...
    const cfaSignInFacebook = () => {
        return new Observable(observer => {
            // get the provider id
            const providerId = firebase$1.auth.FacebookAuthProvider.PROVIDER_ID;
            // native sign in
            plugin.signIn({ providerId }).then((result) => {
                // create the credentials
                const credential = firebase$1.auth.FacebookAuthProvider.credential(result.idToken);
                // web sign in
                firebase$1.app().auth().signInWithCredential(credential)
                    .then((userCredential) => {
                    observer.next(userCredential.user);
    ...
    const cfaSignInApple = () => {
        return new Observable(observer => {
            ...
            plugin.signIn({ providerId: cfaSignInAppleProvider }).then((result) => {
                ...
                const provider = new firebase$1.auth.OAuthProvider('apple.com');
    ...
    const cfaSignInPhone = (phone, verificationCode) => {
        return new Observable(observer => {
            // get the provider id
            const providerId = firebase$1.auth.PhoneAuthProvider.PROVIDER_ID;
            plugin.signIn({ providerId, data: { phone, verificationCode } }).then((result) => {
                ...
                // create the credentials
                const credential = firebase$1.auth.PhoneAuthProvider.credential(result.verificationId, result.verificationCode);
                // web sign in
                firebase$1.app().auth().signInWithCredential(credential)
                    .then((userCredential) => {
                    observer.next(userCredential.user);
     ...
     * ```
     */
    const mapUserToUserInfo = () => pipe(switchMap((user) => {
        if (user) {
     ...
     * ```
     */
    const mapUserCredentialToUserInfo = () => pipe(switchMap(({ userCredential }) => {
        if (!!userCredential) {
    ...
    exports.AppleSignInResult = AppleSignInResult;
    exports.CapacitorFirebaseAuth = CapacitorFirebaseAuth;
    exports.CapacitorFirebaseAuthWeb = CapacitorFirebaseAuthWeb;
    exports.FacebookSignInResult = FacebookSignInResult;
    exports.GoogleSignInResult = GoogleSignInResult;
    exports.PhoneSignInResult = PhoneSignInResult;
    exports.TwitterSignInResult = TwitterSignInResult;
    exports.cfaSignIn = cfaSignIn;
    exports.cfaSignInApple = cfaSignInApple;
    exports.cfaSignInAppleProvider = cfaSignInAppleProvider;
    exports.cfaSignInFacebook = cfaSignInFacebook;
    exports.cfaSignInGoogle = cfaSignInGoogle;
    exports.cfaSignInPhone = cfaSignInPhone;
    exports.cfaSignInPhoneOnCodeReceived = cfaSignInPhoneOnCodeReceived;
    exports.cfaSignInPhoneOnCodeSent = cfaSignInPhoneOnCodeSent;
    exports.cfaSignInTwitter = cfaSignInTwitter;
    exports.cfaSignOut = cfaSignOut;
    exports.mapUserCredentialToUserInfo = mapUserCredentialToUserInfo;
    exports.mapUserToUserInfo = mapUserToUserInfo;
